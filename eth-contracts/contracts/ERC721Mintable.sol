...
contract Ownable {
    ...
    modifier onlyOwner {
        require(msg.sender == _owner, "Requester isn't allowed");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0x0), "Address of new owner not recognized");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    function setPauseState(bool newState) public onlyOwner {
        _paused = newState;
        if (_paused == true) {
    ...
    modifier paused {
        require(_paused == true, "Contract isn't paused");
        _;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "Address can't be the owner of the token");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Sender isn't approved");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == address(0x0), "Token already exist");
        require(to != address(0x0), "Invalid recepient address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Sender isn't the owner of the token");

        // TODO: require token is being transfered to valid address
        require(to != address(0x0), "Recepient address is invalid");
...
contract ERC721TokenFinal is ERC721Metadata {
    ...
    function _mint(address to, uint256 tokenId, string memory tokenURI) public onlyOwner whenNotPaused returns (bool) {
        super._mint(to, tokenId);
        setTokenURI(tokenId);
